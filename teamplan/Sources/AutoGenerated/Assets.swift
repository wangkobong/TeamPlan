...
internal enum Gen {
  ...
  internal enum Images {
    ...
    internal static let appleLogoLoginView = ImageAsset(name: "apple_logo_loginView")
    internal static let bombIconLoginView = ImageAsset(name: "bomb_icon_loginView")
    internal static let descriptionLoginView = ImageAsset(name: "description_loginView")
    internal static let googleLogoLoginView = ImageAsset(name: "google_logo_loginView")
    internal static let squareLoginView1 = ImageAsset(name: "square_loginView_1")
    internal static let squareLoginView2 = ImageAsset(name: "square_loginView_2")
    internal static let todopangLogoLoginView = ImageAsset(name: "todopang_logo_loginView")
    internal static let waterdropIconLoginView = ImageAsset(name: "waterdrop_icon_loginView")
    ...
    internal static let onboardingDescription1 = ImageAsset(name: "onboarding_description1")
    internal static let onboardingDescription2 = ImageAsset(name: "onboarding_description2")
    internal static let onboardingDescription3 = ImageAsset(name: "onboarding_description3")
    internal static let onboardingDescription4 = ImageAsset(name: "onboarding_description4")
    internal static let onboardingImage1 = ImageAsset(name: "onboarding_image1")
